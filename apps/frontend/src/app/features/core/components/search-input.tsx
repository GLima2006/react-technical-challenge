...
const commonClasses =
  "h-12 w-full rounded-lg pl-3 bg-transparent-15 text-neutral-lightest placeholder:text-transparent-50 text-black";
const defaultClasses =
  "placeholder:hover:text-neutral-lightest placeholder:focus:text-neutral-lightest placeholder:transition placeholder:ease-out placeholder:duration-250";
